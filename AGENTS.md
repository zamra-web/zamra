...
- **Poster theme variety** — poster exports (JPEG/PDF + video) randomize from a larger curated palette per generation. Do not revert to deterministic per‑sector coloring; the variety is intentional for social sharing.
