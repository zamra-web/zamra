...
- **Poster social publishing is market-driven** — the admin poster page now has a dedicated Social Publishing panel for Saudi, UAE, Bahrain, Oman, Kuwait, and Qatar. These buttons use the selected date range, not the current preview stack or sector dropdown.
